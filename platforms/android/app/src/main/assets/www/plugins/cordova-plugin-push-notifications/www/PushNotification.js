cordova.define("cordova-plugin-push-notifications.PushNotification", function(require, exports, module) {
...
exports.onPush = function (success, error = function() {}) {
  if (typeof success != 'function') {
    console.error('pushNotification.onPush() failure: success parameter must be a function')
    return
  }
  exec(success, error, 'PushNotification', 'onPush')
}
